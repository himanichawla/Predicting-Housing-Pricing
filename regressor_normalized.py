...
#print(n, end="\n")
#print (attr)
reg = [LinearRegression(),Ridge(alpha=0.001,fit_intercept=True),SVR(C=1, epsilon=0.2, kernel='rbf')]#,SVR(C=1.0, epsilon=0.2, kernel='linear')][GradientBoostingRegressor(),RandomForestRegressor(),AdaBoostRegressor()]
reg_err = {}
tries = 1
for r in reg:
	print("For model ")
