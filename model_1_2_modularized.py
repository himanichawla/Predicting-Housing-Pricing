...
plt.axis( [1, len( combined_bin_min_errors ), 0, max( combined_bin_model_errors + combined_bin_no_model_errors )] )

line1 = Line2D( range( 1, len( combined_bin_no_model_errors ) + 1 ), combined_bin_no_model_errors, color = 'g', marker = 'D', markersize = 8, linestyle = '--', label = 'Error ( Classification, Bin mean )' )
ax.add_line( line1 )

line2 = Line2D( range( 1, len( combined_bin_model_errors ) + 1 ), combined_bin_model_errors, color = 'r', marker = '*', markersize = 13, linestyle = '--', label = 'Error ( Classification, Regression )' )
ax.add_line( line2 )

line3 = Line2D( range( 1, len( combined_bin_no_model_min_errors ) + 1 ), combined_bin_no_model_min_errors, color = 'c', marker = 's', markersize = 8, linestyle = '--', label = 'Error ( Bin mean | Correct Bin )' )
ax.add_line( line3 )

line4 = Line2D( range( 1, len( combined_bin_min_errors ) + 1 ), combined_bin_min_errors, marker = 'o', markersize = 8, linestyle = '--', label = 'Error ( Regression | Correct Bin )' )
ax.add_line( line4 )
