...
#print(n, end="\n")
reg =linear_model.Lasso(alpha=0.009, fit_intercept=True, normalize=False, precompute=False, copy_X=True, max_iter=1000, tol=0.0001, warm_start=False, positive=False, random_state=None, selection='cyclic') #LinearRegression()#GradientBoostingRegressor()#LinearRegression()#GradientBoostingRegressor()#RandomForestRegressor()#GradientBoostingRegressor()##SGDRegressor()#RandomForestRegressor()#SGDRegressor()##Lasso(fit_intercept=True) #AdaBoostRegressor()#Lasso(fit_intercept=True)#, weights='distance')
